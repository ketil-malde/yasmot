...
a3aae3bacbfbd418d243f0a7e09bf92dae9eab9a python3 -m src.yasmot.main -s --shape 1228,1027 tests/stereo1_Left.csv tests/stereo1_Right.csv
1e856023ea79bc61decdb9499bb4f1e207b775eb python3 -m src.yasmot.main tests/lab2
8c48b6ece4db0ea5d6925954e95214cf89fbaf22 python3 -m src.yasmot.main --max_age 2 --time_pattern frame_\{:d\}.txt tests/lab2
